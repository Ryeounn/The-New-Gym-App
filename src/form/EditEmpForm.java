...
public class EditEmpForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbEditEmp.setFont(new java.awt.Font("Times New Roman", 3, 12)); // NOI18N
        lbEditEmp.setForeground(new java.awt.Color(255, 153, 0));
        lbEditEmp.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbEditEmp.setText("Edit Employee");
        lbEditEmp.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 153, 0), 3));
        lbEditEmp.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        pHeaderLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pHeaderLayout.createSequentialGroup()
                ...
                .addGroup(pHeaderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lbEditEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );

        lbTitle.setFont(new java.awt.Font("Times New Roman", 1, 25)); // NOI18N
        lbTitle.setText("EDIT EMPLOYEE");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtPass, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void pHeaderMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pHeaderMouseClicked
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
        ...
        this.setVisible(false);
    }//GEN-LAST:event_pHeaderMouseClicked
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        try {
            ...
            if (rs.next()) {
                ...
                txtUser.setText(rs.getString("UsernameEmp"));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            String sql = "delete Employee where UsernameEmp=?";
            PreparedStatement psc = conn.prepareStatement(sql);
            psc.setString(1, search);
            psc.executeUpdate();
            JOptionPane.showMessageDialog(this, "Delete Employee Successfully");
            txtFName.setText(null);
            txtLName.setText(null);
            cbbGender.setSelectedIndex(0);
            txtPhone.setText(null);
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if (!flag) {
            try {
                String query = "update Employee set UsernameEmp=?,Password=?,Firstname=?,Lastname=?,Gender=?,Email=?,Phone=?,Address=?,Birthday=?,Salary=? where UsernameEmp=?";
                ...
                psc.executeUpdate();
                JOptionPane.showMessageDialog(this, "Update Employee Succesfully");
